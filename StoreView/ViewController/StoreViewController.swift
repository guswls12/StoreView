        ...
        case 0:
            ...
            cell.sellItemPressed = {
                ...
                let okAlert = UIAlertAction(title: "네", style: UIAlertAction.Style.default) { okAlert in
                    ...
                    self.tempSellArray.remove(at: cellIDX)
        ...
        case 1:
            ...
            cell.buyItemPressed = {
                ...
                let okAlert = UIAlertAction(title: "네", style: UIAlertAction.Style.default) { okAlert in
                    ...
                    self.tempBuyArray.remove(at: cellIDX)
                    collectionView.reloadData()
                }
                let noAlert = UIAlertAction(title: "아니오", style: UIAlertAction.Style.default)
                alert.addAction(okAlert)
    ...
    func creatLayout()->UICollectionViewLayout{
        let layout = UICollectionViewCompositionalLayout{
            ...
            if sectionIndex == 0{
                ...
                // 그룹사이즈
                let grouSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(1), heightDimension: .fractionalHeight(0.4)) // 한 줄 짜리
